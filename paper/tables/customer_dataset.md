...
**Table 2:** The customer table of the running example: twelve 2025 rows with observed churn train the model, and five 2026 rows with unknown churn are scored. Customer c104 has a NULL age; customer c105 carries a gender level unseen in 2025.

| customer_id | created_at | age | gender | churn_flag |
|---|---|---|---|---|
